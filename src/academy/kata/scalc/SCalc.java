    ...
    public static void main(String[] args) {
        ...
        do {
            ...
            String announcement = """
                    ...
                    кавычек. Количество пробелов до, после, между, внутри (<=10) операндов и операторов не лимитируется.
                    
                    1-й операнд - всегда строчный - любая последовательность символов кроме 3-х управляющих символов в
                    скобках - ("+*), не более 10 символов между кавычками. Например: "e4Ёъ#@&~"
                    
                    2-й операнд, как первый, но только при сложении и вычитании (+,-) и также обернут в кавычки,
                    например: "$Yj@/-Ё1Ыi". После оператора должен быть отступ хотя бы в пробел.
